...
l1 = np.zeros((100,100), dtype=np.complex128);m1 = np.zeros((100,100),dtype=np.complex128);n1 = np.zeros((100,100),dtype=np.complex128)
...
print('l ki value are=', np.abs(l1[98,:]))
print('m ki value are=', m1[98,:])
print('n ki value are=', n1[98,:])
