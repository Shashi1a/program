...
w1 = pd.DataFrame(np.abs(l1)).to_csv('./l1_100/0.6_1.csv')
w2 = pd.DataFrame(np.abs(m1)).to_csv('./m1_100/0.6_1.csv')
w3 = pd.DataFrame(np.abs(n1)).to_csv('./n1_100/0.6_1.csv')
#plt.plot(np.linspace(0, 100, 100), np.abs(l1[998, :]))
#plt.plot(np.linspace(0, 100, 100), m1[998, :])
#plt.plot(np.linspace(0, 100, 100), n1[i+1, :])
#plt.ylim(-0.4, 1)
plt.savefig('/flash/TerenzioU/program/DNA_polaron100_chi0.6_1.png')
