...
#parameters   --------------------------------------------------------------------
m=0.031; D=0.04; a=4.45; k=0.04; rho=0.5; beta=0.35; V=0.1; chi=0.6
...
'''
w1 = pd.DataFrame(l1).to_csv('/flash/TerenzioU/program/l1(100/1/0.6).csv')
w2 = pd.DataFrame(m1).to_csv('/flash/TerenzioU/program/m1(100/1/0.6).csv')
w3 = pd.DataFrame(n1).to_csv('/flash/TerenzioU/program/n1(100/1/0.6).csv')
fig, ax = plt.subplots()
plt.plot(np.linspace(0, 100, 100), np.abs(l1[997, :]))
plt.plot(np.linspace(0, 100, 100), m1[997, :])
#plt.plot(np.linspace(0, 100, 100), n1[i+1, :])
plt.ylim(-0.2, 1)
plt.savefig('/flash/TerenzioU/program/DNA_polaron_chi/1/0.6.png')
